C     path:      %P%                                                            
C     revision:  $Revision: 11579 $
C     created:   $Date: 2005-07-07 17:27:54 -0400 (Thu, 07 Jul 2005) $
C     presently: %H%  %T%                                                       
      SUBROUTINE RRTATM(IBMAX_B, H1F, H2F, CO2MX, PBND)  
...
C                                                                        FA00870
     ...
     *                IPHMID,IPDIM,KDIM,KMXNOM,NMOL                             
      COMMON /ADRIVE/ LOWFLG,IREAD,MODEL,ITYPE,NOZERO,NOP,		         FA00940
     *                ANGLEF,RANGEF,BETAF,LENF,AV1,AV2,RO,IPUNCH,        FA00950
     *                XVBAR, HMINF,PHIF,IERRF,HSPACE                     FA00960
                                                                                
      COMMON /c_drive/ ref_lat,hobs,immax_b,                      
...
C                                                                        FA00990
      COMMON /BNDRY/ ZBND(MXFSC),TBND(MXFSC),ALORNZ(MXFSC),  			 FA01000
...
c      COMMON /CMN/HMOD(3),ZMDL(MXZMD),PM(MXZMD),TM(MXZMD),RFNDXM(MXZMD),        
c     *       ZPTH(IM2),PP(IM2),TP(IM2),RFNDXP(IM2),SP(IM2),PPSUM(IM2),          
c     *       TPSUM(IM2),RHOPSM(IM2),IMLOW,WGM(MXZMD),DENW(MXZMD),               
c     *       AMTP(MXMOL,MXPDIM)                                                 
...
C                                                                               
      ...
      real*8 ZMDL(MXZMD),PM(MXZMD),TM(MXZMD),RFNDXM(MXZMD),        
...
c      real*8 :: SEMISS(NBANDS)
c      real*8 :: SOLVAR(NBANDS)
      real*8 PBND(MXLAY)
c	  real*8 ZMDL(MXLAY)
c	  real*8 PM(MXLAY)
c	  real*8 TM(MXLAY)
      ...
      integer :: IMMAX_B, IAER, IATM, ISCAT
c	  integer :: ISTRM, ICLD, IDELM, ICOS, JULDAT
c	  real :: SZA
c	  integer :: ISOLVAR
c	  integer :: NSTR, ISTART, IEND, isccos
...
C                                                                        FA01280
      ...
      CALL ATMPTH (xid,IEMIT, IBMAX_B, H1F, H2F, CO2MX, PBND,
     & ZMDL, PM, TM)                
C                                                                        FA01300
      SECANT = 1.0                                                       FA01310
      nmol_flhdr = nmol                                                      FA0
...
C     IXSECT = IXSCNT/10
      XV1 = V1-25.                                                       FA01370
      XV2 = V2+25.                                                       FA01380
      IF (IXSECT.EQ.1) CALL XAMNTS (XV1,XV2, H1F,H2F)                    FA01390
C                                                                        FA01400
      RETURN                                                             FA01410
C                                                                        FA01420
...
C     ----------------------------------------------------------------          
C                                                                               
      SUBROUTINE ATMPTH (xid,IEMIT, ibmax_b, H1F, H2F, CO2MX, 
     & PBND, ZMDL, PM, TM)
C                                                                        FA01480
C**********************************************************************  FA01490
C                                                                        FA01500
...
C                                                                        FA03360
     ...
     *                MSFLAG,MSWIT,IODFIL,MSTGLE                         FA03440
      COMMON /ADRIVE/ LOWFLG,IREAD,MODEL,ITYPE,NOZERO,NOP,		         FA03450
...
C                                                                        FA03820
     ...
     *                 H2OSL(MXLAY),IPATH(MXLAY),ITYL(MXLAY),
     *                 SECNTA(MXLAY),HT1,HT2,ALTZ(0:MXLAY)
      COMMON /BNDRY/ ZBND(MXFSC),TBND(MXFSC),ALORNZ(MXFSC),ADOPP(MXFSC),
     *              AVOIGT(MXFSC)                           
...
C                                                                        FA04820
C         READ (IRD,900) MODEL,ITYPE,IBMAX_B,NOZERO,NOPRNT,NMOL,IPUNCH,   
C     *                  IFXTYP,MUNITS,RE,HSPACE,XVBAR,CO2MX,REF_LAT      
         XVBAR = 1.0
         ITYPE = 2
         NOZERO = 1
         IBMAX = ABS(IBMAX_B)                                                   
...
C                                                                        FA04860
      ...
      IF (NOPRNT.GE.0) THEN                                                     
         WRITE (*,902)                                                    
         WRITE (*,904) MODEL,ITYPE,IBMAX,NOZERO,NOPRNT,NMOL,IPUNCH,       
     *                   IFXTYP,MUNITS,RE,HSPACE,XVBAR,CO2MX,REF_LAT        
      ENDIF                                                                     
c                                                                               
      M = MODEL                                                          FA04940
...
C                                                                        FA05270
C         IF (IREAD.LE.0) READ (IRD,910) H1F,RANGEF                       
...
C                                                                        FA05430
         CALL MDLATM (ITYPE,M,IREAD,HSPACE,co2mx,ibmax_b)                                     
C                                                                        FA05450
...
C                                                                        FA05740
  110    CONTINUE                                                               
         IF (NOPRNT.GE.0) THEN                                                  
            WRITE (*,914) HMOD,ZH,PH,TH,(HMOLS(K),K=1,NMOL)               
            WRITE (*,916) RHOBAR,(DENP(K,1),K=1,NMOL)                     
         ENDIF                                                                  
C                                                                        FA05770
...
C                                                                        FA05790
  ...
  120    CONTINUE                                                        FA05820
         ...
         IF (NOPRNT.GE.0) THEN                                                  
            WRITE (*,918) HMOD,ZH,PH,TH,RANGE,(HMOLS(K),K=1,NMOL)         
            WRITE (*,920) AMTAIR,(AMOUNT(K,1),K=1,NMOL)                   
         ENDIF                                                                  
         IPATH(1) = 0                                                    FA05860
         LMAX = 1                                                        FA05870
         NLAYRS = 1                                                      FA05880
...
C                                                                        FA06070
         IF (IPUNCH.EQ.1) THEN                                           FA06080
           IFORM = 1                                                            
           WRITE (*,924) IFORM,LMAX,NMOL,SECNT0,HMOD,RANGE,ZH          
C                                                                               
C           -------------------------------------                               
...
C                                                                        FA06850
         IF (NOPRNT.GE.0)   WRITE (*,930) ITYPE                               
C                                                                        FA06870
C      >  READ IN CONTROL CARD 3.2 CONTAINING SLANT PATH PARAMETERS <    FA06880
C                                                                        FA06890
c         IF (IREAD.LE.0)                                                 
c     *         READ (IRD,932) H1F,H2F,ANGLEF,RANGEF,BETAF,LENF,HOBS      
         ANGLEF = 0.
         H1 = H1F                                                        FA06920
         H2 = H2F                                                        FA06930
         ...
         IF (NOPRNT.GE.0) THEN                                                  
            IF (IBMAX_B .LT. 0) THEN                                            
               WRITE (*,933) H1,H2,ANGLE,RANGE,BETA,LEN                       
            ELSE                                                                
               WRITE (*,934) H1,H2,ANGLE,RANGE,BETA,LEN                   
            ENDIF                                                               
         ENDIF                                                                  
C                                                                        FA06990
...
C                                                                        FA07240
         ...
         IF (IREAD.LE.0) THEN                                            
            IF (IBMAX_B .LT. 0) THEN                                            
c               READ (IRD,940) (PBND(IB),IB=1,IBMAX)                             
               IF (NOPRNT.GE.0)                                                 
     *              WRITE (*,943) (IB,PBND(IB),IB=1,IBMAX)                    
            ELSE                                                                
c               READ (IRD,940) (ZBND(IB),IB=1,IBMAX)                      
               IF (NOPRNT.GE.0)                                                 
     *              WRITE (*,942) (IB,ZBND(IB),IB=1,IBMAX)                  
            ENDIF                                                               
         ENDIF                                                           FA07280
C                                                                        FA07290
...
C                                                                        FA09490
     ...
     *                                       (HMOLS(K),K=8,NMOL)                
         ...
         IF (IPUNCH.EQ.1) THEN                                           FA09570
            IFORM = 1                                                           
            WRITE (*,972) IFORM,LMAX,NMOL,SECNT0, H1,H2,ANGLE,LEN                              
         ENDIF                                                                  
         SUMN2 = 0.                                                      FA09600
         SUMRS = 0.                                                      FA09610
         PWTD = 0.                                                       FA09620
...
C                                                                               
  305 WRITE (*,989) (PBND(I),I=1,IBMAX)                                       
...
C                                                                        FA10530
 ...
 951  FORMAT (/,T4,'I',T13,'Z',T22,'P',T34,'T',T42,'REFRACT',T55,               
  ...
  972 FORMAT (1X,I1,I3,I5,F10.6,2A8,' ANG=',F8.3,' LEN=',I2)                                   
  973 FORMAT  (///,'1',3X,'------------------------------------',/,             
...
C     ----------------------------------------------------------------          
C                                                                               
      SUBROUTINE MDLATM (ITYPE,MDL,IREAD,HSPACE,co2mx,ibmax_b)                                
C                                                                        FA23540
C     *****************************************************************  FA23550
...
C                                                                        FA23790
c      COMMON /CMN/HMOD(3),ZMDL(MXZMD),PM(MXZMD),TM(MXZMD),RFNDXM(MXZMD),        
c     *       ZPTH(IM2),PP(IM2),TP(IM2),RFNDXP(IM2),SP(IM2),PPSUM(IM2),   FA23810
c     *       TPSUM(IM2),RHOPSM(IM2),IMLOW,WGM(MXZMD),DENW(MXZMD),        FA23820
c     *       AMTP(MXMOL,MXPDIM)                                          FA23830
C                                                                        FA23840
...
C                                                                        FA24160
   30 CONTINUE                                                           FA24170
C                                                                        FA24180
c      READ (ATMNAM(MDL),900) (HMOD(L),L=1,3)                             FA24190
      GO TO 50                                                           FA24200
C                                                                        FA24210
   40 CALL NSMDL (ITYPE,MDL,co2mx,ibmax_b)                                                    
C                                                                        FA24230
      if (imoldq.eq.-99) then                                                   
...
C     ----------------------------------------------------------------          
C                                                                               
      SUBROUTINE NSMDL (ITYPE,MDL,co2mx,ibmax_b)                                              
C                                                                        FA24480
C     *****************************************************************  FA24490
C                                                                        FA24500
C                                                                        FA24510
...
C                                                                        FA24850
c      COMMON /CMN/HMOD(3),ZMDL(MXZMD),PM(MXZMD),TM(MXZMD),RFNDXM(MXZMD),        
c     *       ZPTH(IM2),PP(IM2),TP(IM2),RFNDXP(IM2),SP(IM2),PPSUM(IM2),   FA24870
c     *       TPSUM(IM2),RHOPSM(IM2),IMLOW,WGM(MXZMD),DENW(MXZMD),         FA2488
c     *       AMTP(MXMOL,MXPDIM)                                          FA24890
C                                                                        FA24900
...
C                                                                        FA25540
      WRITE (*,900)                                                      FA25550
      WRITE (*,905)                                                      FA25560
      WRITE (*,910) (I,HMOLS(I),I=1,MXMOL)                               FA25570
      WRITE (*,915)                                                      FA25580
C                                                                        FA25590
      RETURN                                                             FA25600
C                                                                        FA25610
...
C                                                                        FA26670
      CHARACTER*8      HMOD                                             &FA24840
c      COMMON /CMN/HMOD(3),                                                      
c     *       ZMDL_st(MXZMD),PM_st(MXZMD),TM_st(MXZMD),RFNDXM_st(MXZMD),         
c     *       ZPTH(IM2),PP(IM2),TP(IM2),RFNDXP(IM2),SP(IM2),PPSUM(IM2),   FA24870
c     *       TPSUM(IM2),RHOPSM(IM2),IMLOW,WGM(MXZMD),DENW(MXZMD),        FA24880
c     *       AMTP(MXMOL,MXPDIM)                                          FA24890
C                                                                        FA24900
...
c                                                                               
      ...
      COMMON /c_drive/ ref_lat,hobs,immax_dum,                    
     *                 lvl_1_2,jchar_st(10,2),wm(mxzmd)                         
c                                                                               
      character*1 jchar_st                                                      
c                                                                               
...
C     **********************************************************         FA26930
C                                                                        FA26940
C      READ (IRD,900) ZMDL,PM,TM,JCHARP,JCHART,JLONG,                            
C     *               (JCHAR(K),K=1,MXMOL)  
C		//TODO: fix me, units 
		JCHARP = 'A'       
		JCHART = 'A'        
...
C                                                                        FA33380
            IF (RANGE.GT.2.0.AND.BETA.GT.0) THEN                         FA33390
               CALL FDBETA (H1,H2,BETA,ANGLE,PHI,LEN,HMIN,IERROR, PBND)  FA33400
            ELSE                                                         FA33410
               LEN = 0                                                   FA33420
...
C                                                                        FA33490
            CALL FDBETA (H1,H2,BETA,ANGLE,PHI,LEN,HMIN,IERROR, PBND)     FA33510
         ENDIF                                                                  
      ENDIF                                                                     
C                                                                        FA33530
...
C     ----------------------------------------------------------------          
C                                                                               
      SUBROUTINE FDBETA (H1,H2,BETAS,ANGLE,PHI,LEN,HMIN,IERROR, PBND)    FA34760
C                                                                        FA34770
C     *****************************************************************  FA34780
...
C                                                                        FA34880
     ...
     *                IPHMID,IPDIM,KDIM,KMXNOM,NMOL                      FA34940
      COMMON /BNDRY/ ZBND(MXFSC),TBND(MXFSC),ALORNZ(MXFSC),  FA34950
...
C                                                                        FA39320
      CALL AMERGE (H1,H2,HMIN,LEN, PBND)                                 FA39330
...
C     ----------------------------------------------------------------          
C                                                                               
      SUBROUTINE AMERGE (H1,H2,HMIN,LEN, PBND)                           FA40460
C                                                                        FA40470
C     *****************************************************************  FA40480
...
C                                                                        FA40780
      ...
      COMMON /BNDRY/ ZBND(MXFSC),TBND(MXFSC),ALORNZ(MXFSC),  FA40800
...
c     *       AMTP(MXMOL,MXPDIM)
C                                                                        FA44820
      COMMON /BNDRY/ ZBND(MXFSC),TBND(MXFSC),ALORNZ(MXFSC), 			 
...
C     ----------------------------------------------------------------          
C                                                                               
      SUBROUTINE XAMNTS (XV1,XV2, H1F,H2F)                              FX00010
C                                                                        FX00020
C     *****************************************************************  FX00030
...
C                                                                        FX00360
     ...
     *                RADCN1,RADCN2                                             
      COMMON /CNSTATM/ PZERO,TZERO,ADCON,ALZERO,AVMWT,AIRMWT,AMWT(MXMOL)        
      COMMON /ADRIVE/ LOWFLG,IREAD,MODEL,ITYPE,NOZERO,NOP,		         FX00400
...
C                                                                        FX01300
      CALL XPROFL (IPRFL,co2mx,ibmax_b)                                  FX01310
C                                                                        FX01320
...
C                                                                               
     ...
     *                         (XAMNT(K,1),K=8,NMOL)                     FX02560
            ENDIF                                                               
         ELSE                                                            FX02570
            WRITE (*,960) IFRMX,LMAX,NMOL,SECNT0,H1F,H2F,ANGLE,LENF
         ENDIF                                                           FX02600
      ENDIF                                                              FX02610
C                                                                        FX02620
...
C                                                                        FX03150
  ...
  960 FORMAT (1X,I1,I3,I5,F10.6,2A8,' ANG=', F8.3,' LEN=',I2)
...
C     ----------------------------------------------------------------          
C                                                                               
      SUBROUTINE XPROFL (IPRFL,co2mx,ibmax_b)                            FX03430
C                                                                        FX03440
C     *****************************************************************  FX03450
