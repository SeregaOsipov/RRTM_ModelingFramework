...
C     $Author: jdelamer $
C     $Revision: 11569 $
C     $Date: 2004-04-15 14:42:10 -0400 (Thu, 15 Apr 2004) $
      SUBROUTINE CLDPROP(ICLDATM,IAER, NSTR, IOUT, ISTART, IEND, ICLD)
...
c Open (OUT_CLD_RRTM + args) to output the cloud optical properties
      ICD = 25
      OPEN (ICD,FILE=outpuCldFN,FORM='FORMATTED')
      WRITE(ICD,8900)
      NPRELAY = 0
